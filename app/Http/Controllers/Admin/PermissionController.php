...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('newLayout.permission.index', compact('permissions'));
    }
    ...
    {
        return view('newLayout.permission.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('newLayout.permission.edit', compact('permission'));
    }
