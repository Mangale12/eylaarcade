            ...
            try {                
                ...
                if(!empty($settings['bonus_report_emails'])){
                    ...
                    foreach($emails as $a){
                        ...
                        Mail::to("redninoteat@gmail.com")->send(new customMail(json_encode($data)));
                        Log::channel('cronLog')->info("Colab Report Mail sent successfully to redninoteat@gmail.com & ".$a);
                    }
                }
            } catch (\Exception $ex) {
