...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Animated 404 Page - Workshop</title>

  <link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700'><link rel="stylesheet" href="./style.css">
...
<body>
  ...
  <p class="textB">404</p>
  <a class="textC" href="{{ route('homePage') }}">Go Back</a>
...
<svg class="page-not-found" viewBox="0 0 1280 1024">
		  <title>Page Not Found</title>
		    ...
		    <g class="hide bottom-triangles">
			      ...
			      <polygon points="548.3 732.9 520.4 628.4 687 671 548.3 732.9" style="fill: #00b3ac"/>
		    </g>
...
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.2/TweenMax.min.js'></script>
<script src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/SplitText.min.js'></script>
<script src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/DrawSVGPlugin.min.js'></script><script  src="./script.js"></script>
