...
<body>
    ...
    <div class="page-wrapper font-robo">
        <div class="wrapper wrapper--w680">
                    ...
                    <form id="regForm" action="{{ route('forms.stores') }}" method="POST" >
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-md-6 col-sm-12 mt-4">
                                <div class="input-group">
                                    <div class = "text-center">
                                        <h4><b><span class="neon-text referred-by">Referred By (If Applies)</span></b></h4>
                                    </div>
            ...
            <script>
                document.getElementById("captcha_image").src="https://card.handy777.net/captcha_image.php?"+Math.random();
                var captchaImage = document.getElementById("captcha_image");

                var refreshButton = document.getElementById("refresh-captcha");
                refreshButton.onclick = function(event) {
                    event.preventDefault();
                    captchaImage.src = "https://card.handy777.net/captcha_image.php?"+Math.random();
                }
            </script>
