...
@endphp
      <div id="myModal" class="modal">
          <div style="background: rgba(0, 0, -10, 0.6); background-image: url(/images/spinnerbackground.png); width:100%; height: 195%;background-position: fixed;background-repeat: no-repeat;background-size: cover;" > 
         <!-- Modal content -->
      ...
      <!--</video>-->
      <div style="background: rgba(0, 0, -10, 0.6); background-image: url(/images/spinnerbackground.png);">
      <div class="container">
         <div class="aside_playing">
            <div id="playing_players_list">
               <strong>
               ...
               @if (isset($player_name)) 
                ...
                <li id="demo" style="background:rgba(0,0,0,0.6);border:1px solid red;border-radius:5px;padding:5px;margin-bottom:10px;padding:10px;list-style:none;display:flex;justify-content:space-between">
                    ...
                    <span class="next-spin animated_rainbow_1" style="font-size:2rem">
                        {{ maskPlayerName($row['player_name']) }}
                    </span>
                </li>
            @endforeach
         ...
         <div class="aside_winners">
            <div id="past_winners_list">
               <strong>
                  <h3 style="margin-left:0px">
                     <b>
                     <span class="next-spin animated_rainbow_1 font-weight-bold" style="font-size:2rem;">Past winners</span>
                     </b>
                  </h3>
               </strong>
               <ul>
