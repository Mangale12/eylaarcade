...
@endphp
            ...
            <div id="modal_main_content" style="font-size:18px!important">
               <center style="font-size:18px!important">
                  ...
                  <p class="next-spin animated_rainbow_1" style="font-size:18px!important">
                     Congratulations 
                     <text id='winnerinfolaters' style="font-weight:bold; font-size:12px!important" class="next-spin animated_rainbow_1"></text>
                     you have won the monthly spinner of wood games
                  </p>
                  <p class="next-spin animated_rainbow_1" style="font-size:18px!important">
                  ...
                  <p class="next-spin animated_rainbow_1" style="font-size:18px!important">Wood Games</p>
                  <br>
               </center>
            </div>
         </div>
      ...
      <div id="welcome_container">
         <div id="timer" >
            ...
            <img src="{{asset('images/'.$setting->theme.'/'.$theme->logo)}}" id="mainlogo">
         </div>
      </div>
      </div>
      <script>
      ...
      <div class="container">
         ...
         <div class="center">
            ...
            <div class="text-center pt-3">
               <h6>
                  <b>
                  <span class="next-spin animated_rainbow_1 font-weight-bold" style="font-size:2rem;">Copyright Woodswoodgames</span>
