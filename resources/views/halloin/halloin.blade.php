...
<link rel="shortcut icon" href="https://handy777.net/images/handy_fav.png" type="image/x-icon">
    ...
    <style>
        body {
            ...
            background-image: url('images/halloin.png');
        ...
        .form-title {
    font-size: 2rem; /* Adjust size to match "HALLOWEEN PARTY" */
    font-weight: bold;
    color: #000; /* Black text color */
    text-align: center;
    margin-bottom: 20px;
    text-transform: uppercase;
    /* Adding text shadow for spooky effect */
    text-shadow: 3px 3px 0px #d2845e, -3px -3px 0px #d2845e, 3px -3px 0px #d2845e, -3px 3px 0px #d2845e;
    background-color: #d2845e; /* Match background color */
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('halloin.store') }}" method="POST">
            @csrf
