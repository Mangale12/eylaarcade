      ...
      <style>
         ...
         @media only screen and (max-width: 600px) {
            #myModal {
                ...
                margin-left: 15%; /* Adjust margin for mobile view */
                margin-top: 30%; /* Adjust vertical margin for mobile */
            }
        }
      </style>
      <!-- The Modal -->
...
@endphp
            ...
            <div id="modal_main_content" style="font-size:18px!important">
               <center style="font-size:18px!important">
                  ...
                  <p class="next-spin animated_rainbow_1" style="font-size:18px!important">
                     Congratulations 
                     <text id='winnerinfolaters' style="font-weight:bold; font-size:20px!important" class="next-spin animated_rainbow_1"></text>
                     you have won the monthly spinner of Handy games
                  </p>
                  <p class="next-spin animated_rainbow_1" style="font-size:18px!important">
                     Please reach out to <b>Handy Admin</b> at messenger for payout with screenshot of win 
                  </p>
      ...
      <div id="welcome_container">
         <div id="timer" >
            ...
            <img style="top: 270%;" src="{{asset('images/'.$setting->theme.'/'.$theme->logo)}}" id="mainlogo">
         </div>
      </div>
      </div>
      <script>
      ...
      <style>
         * {
         ...
         width: 32vw;
         height: 32vw;
         background: url('https://handy777.net/images/handywheel.jpg');
         background-size: cover;
      ...
      <!--</video>-->
      <div style="background: rgba(0, 0, -10, 0.6);">
      <div class="container">
         <div class="aside_playing">
            <div id="playing_players_list">
               ...
               <ul>
                  ...
                  <li id="demo" style="background:rgba(0,0,0,0.6);border:1px solid red;border-radius:5px;padding:5px;margin-bottom:10px;padding:10px;list-style:none;display:flex;justify-content:space-between"><span style="font-size:20px">{{$key+1}}</span>
                     <span class="next-spin animated_rainbow_1" style="font-size:2rem">{{$row['player_name']}}</span>
                  </li>
                  @if (isset($row['bool']) && $row['bool'] == 1)
                  <script>
                     currentKey = '{{$key+1}}';
         ...
         <div class="center">
            ...
            <div class="text-center pt-3">
               <h6>
                  <b>
                  <span class="next-spin animated_rainbow_1 font-weight-bold" style="font-size:2rem;">Copyright Handy Games</span>
